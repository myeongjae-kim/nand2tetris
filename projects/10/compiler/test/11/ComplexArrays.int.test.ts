...
describe('ComplexArraysTest', () => {
  it('should compile Main.jack', async () => {
    const jackPath = './test/res/11/ComplexArrays/Main.jack';
    const tokenXmlPath = './test/res/11/ComplexArrays/MainT.xml';
    const xmlPath = './test/res/11/ComplexArrays/Main.xml';
    const vmPath = './test/res/11/ComplexArrays/Main.vm';
    const expectedVmPath = './test/res/11/expected/ComplexArrays/Main.vm';
