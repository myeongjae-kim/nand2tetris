...
describe('AverageTest', () => {
  it('should compile Main.jack', async () => {
    const jackPath = './test/res/11/Average/Main.jack';
    const tokenXmlPath = './test/res/11/Average/MainT.xml';
    const xmlPath = './test/res/11/Average/Main.xml';
    const vmPath = './test/res/11/Average/Main.vm';
    const expectedVmPath = './test/res/11/expected/Average/Main.vm';
